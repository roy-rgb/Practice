            ...
            <div class="sideoption2">
                ...
                <div class="tbl-sp">
                    <table class="tbl-user-list">
                     ...
                     <td id="btn-status2<?php echo $row['id'];?>"> <button style="background-color:beige; padding:5px;"  onclick="changeStatus(<?php echo $row['id'];?>,<?php echo $row['status']?>)"> <?php echo ($row['status']=='0') ? 'Activate' : 'Deactivate';?> </button></td>
                                    ...
                                    <td>    <button type="button"> <a href='edit.php?id=<?php echo $row['id']; ?>'><i class="fa-solid fa-edit"></i></a> </button>
                                        <button type="button">  <a href='delete.php?del_id=<?php echo $row['id'] ?> '> <i class="fa-solid fa-trash-can"></i></a></button>
                                    </td>
